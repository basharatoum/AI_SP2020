...
def main(argv):
    ...
    for line in input_file:
        ...
        if subexpression.connective ==['not']:
            m[subexpression.subexpressions[0].symbol[0]] = False
        else:
            m[subexpression.symbol[0]] = True
        knowledge_base.subexpressions.append(subexpression)
    input_file.close()
    ...
    print check_true_false(knowledge_base, statement,NegStatement,m)
